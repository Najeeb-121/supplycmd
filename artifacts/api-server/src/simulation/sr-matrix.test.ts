...
function runMatrix() {
  ...
  // SR-03: Supplier Delay
  const sr03 = analyzeSupplierDelay(snapshot, 380, 1270, 7);
  assertEq("SR-03: residualShortage > 0", sr03.residualShortage, 1450); // Hydro mock
  assertEq("SR-03: severity === CRITICAL (has downstream impacts)", sr03.severity, "CRITICAL");
